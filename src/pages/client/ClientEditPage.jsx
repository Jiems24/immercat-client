...
function ClientEditPage() {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      ...
      .then(() => navigate(`/admin/clients/${clientId}`))
      .catch((error) => {
  ...
  return (
    <div className="ClientEditPage page-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-actions">
          ...
          <button type="button" className="btn-secondary" onClick={() => navigate(`/admin/clients/${clientId}`)}>Cancelar</button>
        </div>
      </form>
    </div>
  );
